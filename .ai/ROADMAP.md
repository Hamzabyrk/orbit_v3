...
| **v1.4-07** | Üye satır işlemleri: rol değiştirme, kurumdan çıkarma                                                      | E6'dan kalan · `CredentialsPanel` `components/credentials/` altında ortak · ⚠️ **v1.2-15 zemin kaydı:** ayakta duran ders ataması varken rol değiştirme artık veritabanında **reddediliyor** (`ORB03`). Ekran bunu ele almalı: önce atamaları arşivlet, sonra rolü değiştir — yoksa yönetici açıklanamayan bir hatayla karşılaşır |
