...
| Dilim       | Kapsam                                                                                                     | Dayandığı varsayımlar                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ----------- | ---------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v1.4-00** | 🔴 **Kayıt ile giriş hesabının bağlanması** — `students.auth_user_id` ve `guardians.auth_user_id`          | v1.2-01 · v1.4-01'den **önce** koşar · `create-member` bugün yalnızca üç tabloya yazıyor (ölçüldü) · ✅ **Karar verildi (2026-09-10): ayrı bağlama adımı** — `create-member` sözleşmesi genişletilmiyor (`DECISION_LOG` — "Akademik kayıt ile giriş hesabı ayrı bir adımda bağlanır") · **Zemin ölçüldü:** sütunlar, `on delete set null` yabancı anahtarı ve kısmi tekillik indeksi **hazır**; yazılmayan tek şey satırlar · ⚠️ Canlıda `deneme3` kurumunda **akademik kaydı olmayan bir öğrenci ve bir veli üyeliği var** — dilim onları da bağlamalı · ⚠️ "Bağlanmamış" ara durumu **ekranda görünmek zorunda** (**K-22**) · ⚠️ **`internal_function_calls` tetikleyicisi de bu dilimde ateşlendi** (`PLATFORM_SETTINGS` §5): kurum silindiğinde defter temizlenmiyor ve `outcome` alanı giriş numarası taşıyor. Tablo bugün boş (ölçüldü); karar bu dilimde verilir |
