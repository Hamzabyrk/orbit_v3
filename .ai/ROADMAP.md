...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). Sıradaki dilim **v1.2-07** (`schedule_entries` — ders programı). Gün alanının gerçek olması gerekiyor (**#117**). Sistemin bugünkü durumu: `PROJECT_STATE.md` **§6.1**.
...
| v1.2          | İş tabloları + tenant/rol RLS matrisi — **dilimleri §4.6'da**. v1.2-01…06 kapandı; on üç iş tablosu ve 72 RLS politikası ayakta                                                                                                                                                               | 🟡    |
