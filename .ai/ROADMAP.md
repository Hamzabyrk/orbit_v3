...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). Sıradaki dilim **v1.2-04** (`attendance_sessions`, `attendance_records`). Dört rolün dördünün de kapsamı artık veritabanında kurulu — ilk kez bir dilim, kimin ne göreceğini sıfırdan tanımlamak yerine mevcut kapsamların üzerine yazacak. Sistemin bugünkü durumu: `PROJECT_STATE.md` **§6.1**.
...
| v1.2          | İş tabloları + tenant/rol RLS matrisi — **dilimleri §4.6'da**. v1.2-01…03 kapandı; yedi iş tablosu ve 44 RLS politikası ayakta                                                                                                                                                                | 🟡    |
