...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). Sıradaki dilim **v1.2-08** (`homework_assignments`). `HomeworkCreateDialog` bugün fail-closed çalışıyor; dilimin açılışında bunun hâlâ doğru olduğu ölçülmeli. Sistemin bugünkü durumu: `PROJECT_STATE.md` **§6.1**.
...
| v1.2          | İş tabloları + tenant/rol RLS matrisi — **dilimleri §4.6'da**. v1.2-01…07 kapandı; on dört iş tablosu ve 78 RLS politikası ayakta                                                                                                                                                             | 🟡    |
