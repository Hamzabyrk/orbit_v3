...
| v1.4 (kalan)  | Program/sınav/ödev/ödeme CRUD akışları. ✅ **v1.4-00 … v1.4-03 kapandı** (#261 · #264 · #266 · #268): kayıt–hesap bağı, öğrenci kaydı, sınıf yönetimi ve sınıfa kayıt, yoklama. Her CRUD dilimi açık `organization_id` süzgeci koyar (**§4.12**) ve izini `audit_row_change` ile bırakır                                       | 🟡    |
