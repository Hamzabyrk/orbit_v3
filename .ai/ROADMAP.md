...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). Sıradaki dilim **v1.2-02** (`classes`, `class_enrollments`, `subjects`). v1.2-01 kapandı; #150 de kapandığı için önünde kapı kalmadı. Sistemin bugünkü durumu: `PROJECT_STATE.md` **§6.1**.
...
| v1.2          | İş tabloları + tenant/rol RLS matrisi — **dilimleri §4.6'da**. v1.2-01 kapandı (`students`, `guardians`)                                                                                                                                                                                      | 🟡    |
