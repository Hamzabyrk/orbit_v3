...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). Sıradaki dilim **v1.2-05** (`exams`, `exam_results` + güvenli sıralama görünümü). Kapsam altyapısı kurulu; oradaki asıl iş sıralamanın **isimsiz** gösterilmesi. Sistemin bugünkü durumu: `PROJECT_STATE.md` **§6.1**.
...
| v1.2          | İş tabloları + tenant/rol RLS matrisi — **dilimleri §4.6'da**. v1.2-01…04 kapandı; dokuz iş tablosu ve 56 RLS politikası ayakta                                                                                                                                                               | 🟡    |
