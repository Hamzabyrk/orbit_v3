...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). Sıradaki dilim **v1.2-12** — kurum denetim kaydı ekranı (**#149**). v1.2'nin son dilimi ve tek gerçek arayüz işi. Sistemin bugünkü durumu: `PROJECT_STATE.md` **§6.1**.
...
| v1.2          | İş tabloları + tenant/rol RLS matrisi — **dilimleri §4.6'da**. v1.2-01…11 kapandı; 98 RLS politikasının **92'si** zorunlu şifre kilidini taşıyor, kalan altısı kimlik okuması                                                                                                                 | 🟡    |
