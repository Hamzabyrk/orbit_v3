...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). **v1.3 kapandı** (kapanış taraması **§4.10**, devreden iki kayıt **§4.11**). Yürüyen sürüm **v1.4**. **v1.4-00 … v1.4-04 kapandı;** sıradaki dilim **v1.4-05** (ödev akışı). v1.4'ün her CRUD dilimi **açık `organization_id` süzgeci** koyar (**§4.12**), izini **`audit_row_change`** ile bırakır, ve düzeltmesini **kırmızıya dönen** bir testle kanıtlar (**K-23**).
>
...
| v1.4 (kalan)  | Program/sınav/ödev/ödeme CRUD akışları. ✅ **v1.4-00 … v1.4-04 kapandı** (#261 · #264 · #266 · #268 · #270): kayıt–hesap bağı, öğrenci kaydı, sınıf yönetimi ve sınıfa kayıt, yoklama, sınav sonucu girişi. Her CRUD dilimi açık `organization_id` süzgeci koyar (**§4.12**) ve izini `audit_row_change` ile bırakır           | 🟡    |
