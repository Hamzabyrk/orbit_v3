...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). Sıradaki dilim **v1.2-06** (`payment_plans`, `installments`). Ödeme modülü yalnızca **takiptir**: kart verisi ve tahsilat kapsam dışı. Sistemin bugünkü durumu: `PROJECT_STATE.md` **§6.1**.
...
| v1.2          | İş tabloları + tenant/rol RLS matrisi — **dilimleri §4.6'da**. v1.2-01…05 kapandı; on bir iş tablosu ve 65 RLS politikası ayakta                                                                                                                                                              | 🟡    |
