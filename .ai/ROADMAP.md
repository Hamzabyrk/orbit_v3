...
> Son güncelleme: **2026-09-10**. İşaretler: ✅ tamam · 🟡 kısmen · ⬜ başlanmadı · ⚠️ tamam sanılıyordu, değil.
>
...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). **v1.3 kapandı** (kapanış taraması **§4.10**, devreden iki kayıt **§4.11**). Sıradaki sürüm **v1.4** — yetkili CRUD ve operasyon akışları. İlk dilim **v1.4-00**: kayıt ile giriş hesabının bağlanması; sunucu yarısı #261'de indi, ekran yarısı **v1.4-01**'e bitişik. v1.4'ün her CRUD dilimi ayrıca **açık `organization_id` süzgeci** koyar (**§4.12**).
>
...
| v1.4 (kalan)  | Sınıf/program/yoklama/sınav/ödev/ödeme CRUD akışları. **v1.4-00 sunucu yarısıyla açıldı (#261):** kayıt ile giriş hesabını bağlayan dört RPC indi; bağlama **ekranı** v1.4-01'e bitişik, çünkü sistemde henüz 0 akademik kayıt var. Her CRUD dilimi ayrıca açık `organization_id` süzgeci koyar (**§4.12**) ve denetim kaydı yazar (**v1.4-14**) | 🟡    |
...
- [~] **Kayıt ile giriş hesabının bağlanması** (**v1.4-00**). Yukarıdaki maddenin ikinci yarısı ve v1.4'ün **ilk** dilimi. **Sunucu yarısı bitti (#261):** dört RPC, 37 pgTAP iddiası. Kalan: bağlama ekranı ve "bağlanmamış" göstergesi — kontrol noktası **v1.4-01**, çünkü bugün sistemde **0 öğrenci ve 0 veli kaydı** var (ölçüldü).
...
| **v1.4-04**    | Sınav sonucu girişi                                                                                                                                               | v1.2-05 · **#257** — sınav adı veritabanından geliyor, istemcide atılıyor                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
