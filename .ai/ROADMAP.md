...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). **v1.3 kapandı** (kapanış taraması **§4.10**, devreden iki kayıt **§4.11**). Yürüyen sürüm **v1.4**. **v1.4-00, v1.4-01 ve v1.4-02 kapandı;** sıradaki dilim **v1.4-03** (yoklama akışı). v1.4'ün her CRUD dilimi **açık `organization_id` süzgeci** koyar (**§4.12**) ve denetim izini **`audit_row_change`** tetikleyicisiyle bırakır.
>
...
| v1.4 (kalan)  | Program/yoklama/sınav/ödev/ödeme CRUD akışları. ✅ **v1.4-00, v1.4-01 ve v1.4-02 kapandı** (#261 · #264 · #266): kayıt–hesap bağı, öğrenci kaydı, sınıf yönetimi ve sınıfa kayıt. Her CRUD dilimi açık `organization_id` süzgeci koyar (**§4.12**) ve izini `audit_row_change` ile bırakır                                     | 🟡    |
