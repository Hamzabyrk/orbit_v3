...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). Sıradaki dilim **v1.2-09** (`daily_feed_posts` · kişisel `tasks` ve `calendar_events`). Günlük Akış ile Gün Planı **ayrı iki modeldir** (Soru 5) ve bu dilimde karıştırılmamaları asıl iş. Sistemin bugünkü durumu: `PROJECT_STATE.md` **§6.1**.
...
| v1.2          | İş tabloları + tenant/rol RLS matrisi — **dilimleri §4.6'da**. v1.2-01…08 kapandı; on beş iş tablosu ve 84 RLS politikası ayakta                                                                                                                                                              | 🟡    |
