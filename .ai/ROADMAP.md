...
>
> **Açık bulgular `gh issue list`'tedir.** Sayı buraya yazılmıyor: denetimden bir gün sonra eskidi (**K-06**). **v1.3 kapandı** (kapanış taraması **§4.10**, devreden iki kayıt **§4.11**). Yürüyen sürüm **v1.4** — yetkili CRUD ve operasyon akışları. **v1.4-00 ve v1.4-01 kapandı;** sıradaki dilim **v1.4-02** (sınıf yönetimi). v1.4'ün her CRUD dilimi **açık `organization_id` süzgeci** koyar (**§4.12**).
>
...
| v1.4 (kalan)  | Sınıf/program/yoklama/sınav/ödev/ödeme CRUD akışları. ✅ **v1.4-00 ve v1.4-01 kapandı** (#261 · #264): kayıt ile hesabı bağlayan dört RPC, öğrenci numarası, denetim tetikleyicisi, ve ilk gerçek CRUD ekranı. Her CRUD dilimi açık `organization_id` süzgeci koyar (**§4.12**) ve izini tetikleyiciyle bırakır                | 🟡    |
