...
| v1.2          | İş tabloları + tenant/rol RLS matrisi — **dilimleri §4.6'da**. On iki dilim + **on yama dilimi** (v1.2-13…22). ✅ **Release gate v1.2-22'de yeniden ölçüldü** (2026-09-07): 421 pgTAP iddiası, 37 `lives_ok` tek tek okundu, 22/22 tablo FK+RLS. Kapsam turunun 29 bulgusu kapandı veya sahiplendirildi — ayrıntı **§4.8** | ✅    |
